        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.author.store')}}" method="post">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="作者名称" class="form-control" name="author_name"  />
              </div>
            </div>
             <div class="form-group">
              <label class="col-sm-3 control-label">作者描述</label>
              <div class="col-sm-6">
                <input type="text" placeholder="作者描述" class="form-control" name="author_desc"/>
              </div>
            </div>
			 ...
			 <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				  <button class="btn btn-primary btn-danger" id="btn-save">添加作者</button>&nbsp;
