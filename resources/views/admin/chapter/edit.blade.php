    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.chapter.doEdit')}}" method="post">
            	{{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="章节序号" class="form-control" name="sort"  value="{{$chapter->sort}}"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <textarea name="content" style="border:none;" id="container" class="form-control">{{$chapter->desc}}</textarea>
              </div>
            </div>
			 ...
			 <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				  <button class="btn btn-primary btn-danger" id="btn-save">修改章节内容</button>&nbsp;
